...
public class CmdInfo extends CmdBase
{
	...
	public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException
	{
		...
		sender.sendMessage(FTBLib.lang(sender, "commands.team.info.uid", StringUtils.color(new TextComponentString(team.getUID() + " / " + String.format("%08x", team.getUID())), TextFormatting.BLUE)));
